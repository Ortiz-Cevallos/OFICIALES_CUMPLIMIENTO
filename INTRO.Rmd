...
library(kableExtra)
library(latex2exp)
C1<-c("Carmen Patricia Castro Fallas", "Eduardo Rafael Vasquez", "Rocío Beatriz Sol Merino", "Maynor Augusto Ambrosio Higueros", "Eduardo Antonio Chinchilla Mejía", "Jhara Sequeira  Mora", "Sonia Patricia Espino Yunes", "Luis Ernesto Ortiz Cevallos")
