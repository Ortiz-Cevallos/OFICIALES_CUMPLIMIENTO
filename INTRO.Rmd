...
library(kableExtra)
library(latex2exp)
C1<-c("Luis Gustavo Vargas Rodríguez", "Eduardo Rafael Vasquez", "Rocío Beatriz Sol Merino", "Maynor Augusto Ambrosio Higueros", "Eduardo Antonio Chinchilla Mejía", "Carlos Munguía Chang", "Sonia Patricia Espino Yunes", "Luis Ernesto Ortiz Cevallos")
